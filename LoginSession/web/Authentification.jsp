<%-- 
    ...
    Created on : 10 oct. 2023, 11:39:28
    Author     : lenovo
--%>
                ...
                <div class="container">
                    <div class="signin-content">
                        <div class="signin-form">
                            <h2 class="form-title">Anthentification</h2>
                            <form action="Authentification" method="post" class="register-form" id="login-form">
                            ...
                            <a href="Mdp.jsp">Mot de passe oublié</a>
